...
SECRET_KEY = 'e7wjx986cpn@jbd3asiwi)u6xd^9#552r0$p8fnjp)$4w*xo-7'
...
MIDDLEWARE_CLASSES = (
    ...
    'chirp.middlewares.DisneyMiddleware'
)
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = reverse_lazy('list_chirps')
